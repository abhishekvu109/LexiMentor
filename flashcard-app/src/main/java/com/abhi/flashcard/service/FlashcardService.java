...
public interface FlashcardService {
    ...
    FlashcardResponse createFlashcard(String deckRefId, FlashcardRequest request, String userId);

    FlashcardResponse updateFlashcard(String refId, FlashcardRequest request, String userId);
