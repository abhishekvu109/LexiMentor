...
public class DrillMetadataServiceImpl implements DrillMetadataService {
    ...
    public List<DrillMetadataDTO> getDrills() {
        ...
        if (CollectionUtil.isNotEmpty(drillMetadataList))
            return drillMetadataList.stream().map(drillDomainMapper::toDto).toList();
    ...
    private DrillMetadataDTO getEntity(int size, List<WordMetadata> wordMetadataList) {
        ...
        DrillMetadata drillMetadata = drillDomainMapper.toEntity(wordMetadataList, applicationUtil);
    ...
    public void deleteByRefId(long refId) {
        ...
        List<ChallengeEvaluation> challengeEvaluations = drillEvaluationRepository.findByDrillChallengeScoresIn(challengeScores);
...
//    }
    ...
    public DrillMetadataDTO assignDrillName(long drillRefId) {
        ...
        return drillDomainMapper.toDto(drillMetadata);
    }
