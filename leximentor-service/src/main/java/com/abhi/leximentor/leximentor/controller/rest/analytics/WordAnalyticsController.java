...
public class WordAnalyticsController {
    ...
    @GetMapping(value = "/api/leximentor/analytics/words/overview", produces = ApplicationConstants.MediaType.APPLICATION_JSON)
    ...
    @GetMapping(value = "/api/leximentor/analytics/words/distribution", produces = ApplicationConstants.MediaType.APPLICATION_JSON)
    ...
    @GetMapping(value = "/api/leximentor/analytics/words/difficulty", produces = ApplicationConstants.MediaType.APPLICATION_JSON)
