...
@Service
public class IdentifyWordEvaluationStrategy extends AbstractSimpleEvaluationStrategy {
    public IdentifyWordEvaluationStrategy(DrillSetRepository drillSetRepository,
    ...
    public ChallengeType getType() {
        return ChallengeType.IDENTIFY_WORD;
    }
