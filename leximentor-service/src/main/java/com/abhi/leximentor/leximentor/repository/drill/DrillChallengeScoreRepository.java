...
@Repository
public interface DrillChallengeScoreRepository extends JpaRepository<ChallengeScores, Long> {
    public List<ChallengeScores> findByChallengeId(Challenge challengeId);

    public ChallengeScores findByRefId(long refId);

    public ChallengeScores findByDrillSetIdAndChallengeId(DrillSet drillSet, Challenge challenge);
