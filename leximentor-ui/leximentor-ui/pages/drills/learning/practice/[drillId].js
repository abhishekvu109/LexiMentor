...
const LoadDrillSet = ({drillSetData, drillId, wordMetadata, sourcesData}) => {
    ...
    return (<>
        ...
        <div className="container mx-auto m-5 bg-gray-50 border-1">
            ...
            {/*<div className="flex flex-row m-2">*/}
            {/*    <div className="basis-2/4 bg-gray-200 mr-2">*/}
            {/*        <div className="m-2">*/}
            ...
            {/*                               className="form-label font-semibold">Examples</label>*/}
            {/*                        <div>*/}
            {/*                            <select className="form-select">*/}
            ...
            {/*            <textarea className="form-control font-mono text-sm antialiased text-red-700"*/}
            {/*                      id="wordJson"*/}
            {/*                      rows="25"*/}
