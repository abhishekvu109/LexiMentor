...
import com.abhi.leximentor.inventory.service.analytics.engine.handler.drill.*;
...
public class DrillAnalyticsStrategy implements AnalyticsStrategy<DrillAnalyticsDTO> {
    ...
    private AnalyticsPipeline<DrillAnalyticsContext> buildPipeline() {
        ...
        DrillTopChallengingWordsHandler topWordsHandler = new DrillTopChallengingWordsHandler();
