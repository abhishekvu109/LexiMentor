...
//            WordMetadata synonym = wordRepository.findByRefId(dto.getSynonym());
//            if (synonym == null)
...
//            WordMetadata antonym = wordRepository.findByRefId(dto.getAntonym());
//            if (antonym == null)
//                throw new ServerException().new EntityObjectNotFound(ExceptionMessageConstants.WordMetadata.WORD_NOT_FOUND);
