...
public class FlashcardServiceImpl implements FlashcardService {
    ...
    @Override
    @Transactional
    public FlashcardResponse createFlashcard(String deckRefId, FlashcardRequest request) {
    ...
    @Override
    @Transactional
    public FlashcardResponse updateFlashcard(String refId, FlashcardRequest request) {
